---
name: default-opus
description: Blank-slate subagent on the most capable available model (Opus). Use for architecture, design, broad-codebase reasoning, and final code review. The dispatcher's task message is the entire instruction set.
